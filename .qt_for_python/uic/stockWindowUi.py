...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalWidget.setMinimumSize(QtCore.QSize(530, 0))
        self.verticalWidget.setBaseSize(QtCore.QSize(0, 0))
        self.verticalWidget.setObjectName("verticalWidget")
        self.plotLayout = QtWidgets.QVBoxLayout(self.verticalWidget)
